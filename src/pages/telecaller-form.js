...
const TelecallerRegistrationForm = () => {
  ...
  return (
    <Layout
      title="Telecaller Registration"
      description="Register as a Telecaller"
    >
      <PageHeader
        headerBg={storeCustomizationSetting?.term_and_condition?.header_bg}
        title="Telecaller Registration Form"
      />
      {loading ? (
        <CMSkeleton />
      ) : (
...
export default TelecallerRegistrationForm;
